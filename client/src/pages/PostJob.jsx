      ...
      <div className="flex flex-col w-full relative">
        <div className="max-w-[800px] w-full mx-auto pb-24 px-4 md:px-margin-desktop">
          ...
          <div className="mt-8 mb-12">
            <h1 className="font-display-lg text-display-lg text-on-background mb-2">Post a New Job</h1>
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl">
              Find the perfect candidate by providing detailed information about the role.
            </p>
          </div>
