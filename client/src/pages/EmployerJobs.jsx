    ...
    <>
      <aside className="fixed left-0 top-0 h-full w-72 bg-surface-container-low border-r border-white/5 z-50 flex flex-col shadow-2xl">
        ...
        <nav className="flex-1 px-4 space-y-2">
          <Link to="/employer-dashboard" className="flex items-center px-6 py-3 text-on-surface-variant hover:bg-surface-container-highest hover:text-on-surface rounded-xl transition-all border-l-4 border-transparent">
          ...
          <Link to="/employer/jobs" aria-current="page" className="flex items-center px-6 py-3 rounded-xl transition-all bg-secondary-container/20 text-secondary border-l-4 border-secondary">
