      ...
      <div className="max-w-md w-full relative z-10 p-4">
        <div className="bg-surface-container p-8 sm:p-10 rounded-3xl shadow-2xl border border-white/5">
          <div className="text-center mb-8">
            <span className="inline-block py-1 px-3 rounded-full bg-surface-container-high text-secondary font-label-sm text-label-sm mb-4 uppercase tracking-wider">Employer</span>
            <h2 className="text-3xl font-display-lg text-on-surface">
              Company Registration
            </h2>
            <p className="mt-2 text-sm text-on-surface-variant font-body-md">Hire top tech talent directly</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className={`w-full bg-surface-container-highest text-on-surface font-body-md text-body-md rounded-xl pl-12 pr-4 py-3 outline-none focus:ring-2 focus:ring-secondary/50 focus:bg-surface-bright transition-all shadow-inner border ${errors.name ? 'border-error/50' : 'border-white/5'}`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="email"
                    className={`w-full bg-surface-container-highest text-on-surface font-body-md text-body-md rounded-xl pl-12 pr-4 py-3 outline-none focus:ring-2 focus:ring-secondary/50 focus:bg-surface-bright transition-all shadow-inner border ${errors.email ? 'border-error/50' : 'border-white/5'}`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="password"
                    className={`w-full bg-surface-container-highest text-on-surface font-body-md text-body-md rounded-xl pl-12 pr-4 py-3 outline-none focus:ring-2 focus:ring-secondary/50 focus:bg-surface-bright transition-all shadow-inner border ${errors.password ? 'border-error/50' : 'border-white/5'}`}
                    placeholder="••••••••"
                    {...register('password')}
                  />
                </div>
            ...
            <div>
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex justify-center items-center gap-2 py-3 px-4 rounded-xl text-on-secondary bg-gradient-to-r from-secondary to-secondary-container font-label-sm text-label-sm shadow-[0_0_20px_rgba(208,188,255,0.3)] hover:shadow-[0_0_30px_rgba(208,188,255,0.5)] transition-all transform hover:-translate-y-0.5 disabled:opacity-50 focus:outline-none"
              >
                {isLoading ? (
                  <>
