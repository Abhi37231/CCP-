...
const RegisterFresher = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-80px)] bg-surface relative overflow-hidden">
      ...
      <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] bg-secondary/5 rounded-full blur-[100px] pointer-events-none"></div>
      ...
      <div className="max-w-md w-full relative z-10 p-4">
        <div className="bg-surface-container p-8 sm:p-10 rounded-3xl shadow-2xl border border-white/5">
          <div className="text-center mb-8">
            <span className="inline-block py-1 px-3 rounded-full bg-surface-container-high text-primary font-label-sm text-label-sm mb-4 uppercase tracking-wider">Fresher</span>
            <h2 className="text-3xl font-display-lg text-on-surface">
              Candidate Registration
            </h2>
            <p className="mt-2 text-sm text-on-surface-variant font-body-md">Start your career journey with us</p>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className={`w-full bg-surface-container-highest text-on-surface font-body-md text-body-md rounded-xl pl-12 pr-4 py-3 outline-none focus:ring-2 focus:ring-primary/50 focus:bg-surface-bright transition-all shadow-inner border ${errors.name ? 'border-error/50' : 'border-white/5'}`}
